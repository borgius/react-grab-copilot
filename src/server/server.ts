...
export function startServer(context: vscode.ExtensionContext, eventEmitter: EventEmitter, outputChannel: vscode.OutputChannel, statusBarItem: vscode.StatusBarItem): any {
