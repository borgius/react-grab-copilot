...
export class AgentSystemPrompt extends PromptElement<AgentSystemPromptProps, undefined> {
    render() {
        return (
            <>
...
export class FileContentPrompt extends PromptElement<FileContentProps, undefined> {
...
export class SearchResultsPrompt extends PromptElement<SearchResultsProps, undefined> {
    render() {
...
export class ToolResultPrompt extends PromptElement<ToolResultProps, undefined> {
    render() {
...
export class SuccessPrompt extends PromptElement<SuccessMessageProps, undefined> {
    render() {
        return (
            <UserMessage>
...
export class DirectoryListingPrompt extends PromptElement<DirectoryListingProps, undefined> {
    render() {
...
export class ProjectStructurePrompt extends PromptElement<ProjectStructureProps, undefined> {
    render() {
...
export class GitChangesPrompt extends PromptElement<GitChangesProps, undefined> {
    render() {
...
export class DiagnosticsPrompt extends PromptElement<DiagnosticsProps, undefined> {
    render() {
...
export class TerminalOutputPrompt extends PromptElement<TerminalOutputProps, undefined> {
    render() {
